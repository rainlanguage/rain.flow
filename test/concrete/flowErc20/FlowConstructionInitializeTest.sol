...
contract FlowConstructionInitializeTest is FlowERC20Test {
    function testFlowConstructionInitializeERC20(address expression, bytes memory bytecode, uint256[] memory constants)
        external
    {
        ...
        vm.recordLogs();
        iCloneFactory.clone(address(flowImplementation), abi.encode(flowERC20ConfigV2));
